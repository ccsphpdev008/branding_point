                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        <thead class="theme-custom-bg-color">
                            <tr>
                                ...
                                @endif
                                <th scope="col">{{ ucwords(str_replace('_', ' ', 'role')) }}</th>
                                <th scope="col">{{ ucwords(str_replace('_', ' ', 'name')) }}</th>
                                <th scope="col">{{ ucwords(str_replace('_', ' ', 'email')) }}</th>
                                <th scope="col">{{ ucwords(str_replace('_', ' ', 'contact')) }}</th>
                                ...
                                @foreach ($records as $key => $item)
                                    <tr class="theme-custom-text">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.login_as_user', $item->id) }}" class="btn btn-xs btn-info waves-effect waves-light"><i class="material-icons">lock_open</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
