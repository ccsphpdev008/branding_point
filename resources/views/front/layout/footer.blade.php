            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-widget fl-wrap">
                        <div class="footer-logo"><a href="index.html"><img src="{{ asset('public/theme/front/images/logo.png') }}" alt=""></a></div>
                ...
                <div class="col-md-4">
                    <div class="footer-widget fl-wrap">
                        ...
                        <div class="footer-widget-posts fl-wrap">
                            <ul class="no-list-style">
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{ asset('public/theme/front/images/all/4.jpg') }}" class="respimg" alt=""></a>
                                ...
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{ asset('public/theme/front/images/all/2.jpg') }}" class="respimg" alt=""></a>
                                    <div class="widget-posts-descr">
                                ...
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{ asset('public/theme/front/images/all/7.jpg') }}" class="respimg" alt=""></a>
                                    <div class="widget-posts-descr">
