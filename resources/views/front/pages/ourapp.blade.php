        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="collage-image">
                    <img src="{{ asset('public/theme/front/images/api.png') }}" class="main-collage-image" alt="">                               
                    <div class="images-collage-title color2-bg icdec"> <img src="{{ asset('public/theme/front/images/logo.png') }}"   alt=""></div>
                    <div class="images-collage_icon green-bg" style="right:-20px; top:120px;"><i class="fal fa-thumbs-up"></i></div>
                    <div class="collage-image-min cim_1"><img src="{{ asset('public/theme/front/images/api/1.jpg') }}" alt=""></div>
                    <div class="collage-image-min cim_2"><img src="{{ asset('public/theme/front/images/api/2.jpg') }}" alt=""></div>
