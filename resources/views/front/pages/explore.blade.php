            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="listing-item-grid">
                        <div class="bg"  data-bg="{{ asset('public/theme/front/images/all/56.jpg') }}"></div>
                ...
                <div class="col-sm-4">
                    <div class="listing-item-grid">
                        <div class="bg"  data-bg="{{ asset('public/theme/front/images/all/57.jpg') }}"></div>
                        <div class="d-gr-sec"></div>
                ...
                <div class="col-sm-4">
                    <div class="listing-item-grid">
                        <div class="bg"  data-bg="{{ asset('public/theme/front/images/all/58.jpg') }}"></div>
                        <div class="d-gr-sec"></div>
                ...
                <div class="col-sm-4">
                    <div class="listing-item-grid">
                        <div class="bg"  data-bg="{{ asset('public/theme/front/images/all/60.jpg') }}"></div>
                        <div class="d-gr-sec"></div>
                ...
                <div class="col-sm-8">
                    <div class="listing-item-grid">
                        <div class="bg"  data-bg="{{ asset('public/theme/front/images/all/59.jpg') }}"></div>
                        <div class="d-gr-sec"></div>
