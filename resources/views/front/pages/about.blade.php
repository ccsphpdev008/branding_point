...
@section('content')
        ...
        <section class="parallax-section single-par" data-scrollax-parent="true">
            <div class="bg par-elem "  data-bg="{{ asset('public/theme/front/images/bg/30.jpg') }}" data-scrollax="properties: { translateY: '30%' }"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="list-single-main-media fl-wrap" style="box-shadow: 0 9px 26px rgba(58, 87, 135, 0.2);">
                                <img src="{{ asset('public/theme/front/images/all/55.jpg') }}" class="respimg" alt="">
        ...
        <section class="parallax-section video-section" data-scrollax-parent="true" id="sec2">
            <div class="bg par-elem "  data-bg="{{ asset('public/theme/front/images/bg/34.jpg') }}" data-scrollax="properties: { translateY: '30%' }"></div>
            <div class="overlay op7"></div>
            <!--container-->
            <div class="container">
                ...
                <div class="about-wrap team-box2 fl-wrap">
                    ...
                    <div class="team-box">
                        <div class="team-photo">
                            <img src="{{ asset('public/theme/front/images/team/2.jpg') }}" alt="" class="respimg">
                        </div>
                    ...
                    <div class="team-box">
                        <div class="team-photo">
                            <img src="{{ asset('public/theme/front/images/team/3.jpg') }}" alt="" class="respimg">
                        </div>
                        <div class="team-info fl-wrap">
                    ...
                    <div class="team-box">
                        <div class="team-photo">
                            <img src="{{ asset('public/theme/front/images/team/4.jpg') }}" alt="" class="respimg">
                        </div>
                        <div class="team-info fl-wrap">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="client-item"><img src="{{ asset('public/theme/front/images/clients/1.png') }}" alt=""></a>
                                </div>
                                <!--client-item end-->
                                <!--client-item-->
                                <div class="swiper-slide">
                                    <a href="#" class="client-item"><img src="{{ asset('public/theme/front/images/clients/2.png') }}" alt=""></a>
                                </div>
                                <!--client-item end-->
                                <!--client-item-->
                                <div class="swiper-slide">
                                    <a href="#" class="client-item"><img src="{{ asset('public/theme/front/images/clients/3.png') }}" alt=""></a>
                                </div>
                                <!--client-item end-->
                                <!--client-item-->
                                <div class="swiper-slide">
        ...
        <section class="parallax-section" data-scrollax-parent="true" id="sec4">
            <div class="bg par-elem "  data-bg="{{ asset('public/theme/front/images/bg/33.jpg') }}" data-scrollax="properties: { translateY: '30%' }"></div>
            <div class="overlay op7"></div>
            <!--container-->
            <div class="container">
                <div class="section-title center-align big-title">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testi-item fl-wrap">
                                    <div class="testi-avatar"><img src="{{ asset('public/theme/front/images/avatar/4.jpg') }}" alt=""></div>
